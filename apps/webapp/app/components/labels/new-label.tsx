...
import { generateOklchColor } from "../ui/color-utils";
...
export function NewLabel({ onCancel, onSuccess }: NewLabelProps) {
  ...
  return (
    <div className="bg-background-3 group mb-2 flex flex-col gap-3 rounded p-4">
