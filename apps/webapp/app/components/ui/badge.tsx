...
const badgeVariants = cva(
  "flex items-center h-5 gap-2 rounded-md border px-2 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
        ...
        ghost: "border-none bg-transparent hover:bg-grayAlpha-100",
        destructive:
